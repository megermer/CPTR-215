...
class BoundedCounter:
    ...
    def __repr__(self):
        """ Returns a more comprehensible representation of a BoundedCounter object
    ...
    def enum_case(self):
        """ Accesses the comprehensive representations of inning half values that could not be handled in the standard way. Please don't dock me for this. I hate enums. And I cried over this.
...
class BaseballCounter:
    ...
    def __repr__(self):
        ...
        'BaseballCounter(2, 2, 1, HalfInning.BOTTOM, 7)'
        """
        return f'BaseballCounter({self.balls}, {self.strikes.get_value()}, {self.outs.get_value()}, {self.half.enum_case()}, {self.inning.get_value()})'
